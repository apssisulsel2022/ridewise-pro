...
export const dummyRoutes: Route[] = [
  { id: 'r1', name: 'Hermes → Kualanamu', rayon: 'A', origin: 'Hermes', destination: 'Kualanamu', distanceMeters: 38000 },
  { id: 'r2', name: 'Amplas → Parapat', rayon: 'A', origin: 'Amplas', destination: 'Parapat', distanceMeters: 175000 },
  { id: 'r3', name: 'Pinang Baris → Sibolga', rayon: 'B', origin: 'Pinang Baris', destination: 'Sibolga', distanceMeters: 280000 },
  { id: 'r4', name: 'Medan → Berastagi', rayon: 'B', origin: 'Medan', destination: 'Berastagi', distanceMeters: 66000 },
  { id: 'r5', name: 'Medan → Pematang Siantar', rayon: 'C', origin: 'Medan', destination: 'Pematang Siantar', distanceMeters: 128000 },
  { id: 'r6', name: 'Medan → Rantau Prapat', rayon: 'C', origin: 'Medan', destination: 'Rantau Prapat', distanceMeters: 285000 },
  { id: 'r7', name: 'Medan → Padang Sidempuan', rayon: 'D', origin: 'Medan', destination: 'Padang Sidempuan', distanceMeters: 390000 },
  { id: 'r8', name: 'Medan → Kisaran', rayon: 'D', origin: 'Medan', destination: 'Kisaran', distanceMeters: 195000 },
];

export const dummyRoutePoints: RoutePoint[] = [
  { id: 'rp1', routeId: 'r1', code: 'J1', name: 'Terminal Hermes', order: 1, lat: 3.5952, lng: 98.6722, price: 76000 },
  { id: 'rp2', routeId: 'r1', code: 'J2', name: 'Simpang Pos', order: 2, lat: 3.5880, lng: 98.6850, price: 70000 },
  { id: 'rp3', routeId: 'r1', code: 'J3', name: 'Tembung', order: 3, lat: 3.5750, lng: 98.7200, price: 65000 },
  { id: 'rp4', routeId: 'r1', code: 'J4', name: 'Batang Kuis', order: 4, lat: 3.5400, lng: 98.7600, price: 55000 },
  { id: 'rp5', routeId: 'r1', code: 'J5', name: 'Bandara Kualanamu', order: 5, lat: 3.6422, lng: 98.8853, price: 0 },
  { id: 'rp6', routeId: 'r2', code: 'J1', name: 'Terminal Amplas', order: 1, lat: 3.5570, lng: 98.6950, price: 262500 },
  { id: 'rp7', routeId: 'r2', code: 'J2', name: 'Lubuk Pakam', order: 2, lat: 3.5550, lng: 98.8570, price: 240000 },
  { id: 'rp8', routeId: 'r2', code: 'J3', name: 'Tebing Tinggi', order: 3, lat: 3.3283, lng: 99.1627, price: 200000 },
  { id: 'rp9', routeId: 'r2', code: 'J4', name: 'Seribu Dolok', order: 4, lat: 2.9000, lng: 99.0500, price: 150000 },
  { id: 'rp10', routeId: 'r2', code: 'J5', name: 'Parapat', order: 5, lat: 2.6640, lng: 98.9380, price: 0 },
  { id: 'rp11', routeId: 'r3', code: 'J1', name: 'Pinang Baris', order: 1, lat: 3.6100, lng: 98.6350, price: 336000 },
  { id: 'rp12', routeId: 'r3', code: 'J2', name: 'Binjai', order: 2, lat: 3.6000, lng: 98.4850, price: 310000 },
  { id: 'rp13', routeId: 'r3', code: 'J3', name: 'Sibolga', order: 3, lat: 1.7427, lng: 98.7792, price: 0 },
  { id: 'rp14', routeId: 'r4', code: 'J1', name: 'Medan Center', order: 1, lat: 3.5952, lng: 98.6722, price: 132000 },
  { id: 'rp15', routeId: 'r4', code: 'J2', name: 'Pancur Batu', order: 2, lat: 3.4700, lng: 98.5700, price: 110000 },
  { id: 'rp16', routeId: 'r4', code: 'J3', name: 'Berastagi', order: 3, lat: 3.1972, lng: 98.5081, price: 0 },
  { id: 'rp17', routeId: 'r5', code: 'J1', name: 'Medan Timur', order: 1, lat: 3.6000, lng: 98.7000, price: 192000 },
  { id: 'rp18', routeId: 'r5', code: 'J2', name: 'P. Siantar', order: 2, lat: 2.9540, lng: 99.0478, price: 0 },
  { id: 'rp19', routeId: 'r6', code: 'J1', name: 'Medan Barat', order: 1, lat: 3.5900, lng: 98.6600, price: 342000 },
  { id: 'rp20', routeId: 'r6', code: 'J2', name: 'Rantau Prapat', order: 2, lat: 2.0975, lng: 99.8308, price: 0 },
  { id: 'rp21', routeId: 'r7', code: 'J1', name: 'Medan Selatan', order: 1, lat: 3.5800, lng: 98.6800, price: 390000 },
  { id: 'rp22', routeId: 'r7', code: 'J2', name: 'Padang Sidempuan', order: 2, lat: 1.3790, lng: 99.2718, price: 0 },
  { id: 'rp23', routeId: 'r8', code: 'J1', name: 'Medan Utara', order: 1, lat: 3.6200, lng: 98.6700, price: 253500 },
  { id: 'rp24', routeId: 'r8', code: 'J2', name: 'Kisaran', order: 2, lat: 2.9833, lng: 99.6167, price: 0 },
];
